...
module.exports = {
    getAllUsers: async (req, res) => {
        try {
            const users = await User.find().lean(); // Sử dụng phương thức lean() để trả về plain JavaScript objects thay vì Mongoose documents
            ...
            // Sắp xếp theo userID
            simplifiedUsers.sort((a, b) => a.userID - b.userID);
